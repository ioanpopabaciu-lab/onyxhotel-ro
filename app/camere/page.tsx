...
const camere = [
  ...
  { name: "Cameră Dublă", desc: "Spațioasă cu pat matrimonial sau două paturi separate. Perfectă pentru cupluri sau colegi de afaceri.", features: ["Pat matrimonial sau twin", "Baie privată completă", "TV + Wi-Fi gratuit", "Climatizare", "Minibar"], pret: "230", img: "/images/hotel-2.jpg" },
